...
Contributions are welcome — bug reports, fixes, and improvements to the Hammerspoon Nix configuration.
...
- Test changes on macOS — Hammerspoon is macOS-only
...
- Your macOS version and nixpkgs channel
- Steps to reproduce
